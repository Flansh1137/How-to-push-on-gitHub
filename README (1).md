## 🚀 Main Branch Setup (Git Commands)

Use Command Prompt (CMD) or PowerShell --- the commands are the same in
both.
...
> **Note:** The same commands work for both CMD and PowerShell.
